        ...
        <div className="row m-4 align-items-center">
          ...
          <div className="col-md-2">
            <strong style={{ fontSize: "20px" }}>
              {flightDetails.sourceAirportStateName}
            </strong>
          </div>

          <div className="col-md-2 text-center">
            <i
              className="fa-solid fa-plane text-warning"
              style={{ fontSize: "30px" }}
            ></i>
            <br></br> <small>{flightDetails.duration}</small>
          </div>

          <div className="col-md-3">
            <strong style={{ fontSize: "18px" }}>
              {flightDetails?.departureTime?.split("T")[0]}
            </strong>
            <i
            ...
            ></i>
            <strong style={{ fontSize: "18px" }}>
              {flightDetails?.arrivalTime?.split("T")[0]}
            </strong>
            <br></br> DAC &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; JDK
        ...
        <div className="row">
            ...
            <div className="container border">
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  ...
                  <i
                    className="fa-solid fa-arrow-right px-4"
                    style={{ fontSize: "25px" }}
                  ></i>
                  <br></br>
                  {flightDetails.duration}
              ...
              <div className="row p-1">
                ...
                <div className="col">
                  ...
                  <div className="bg-warning w-100 p-2 row">
                    <span
                      className="col-2 col-md-2 fw-bolder"
                      style={{ fontSize: "16px" }}
                    >
                      Destination
                    </span>
                    <span className=" col-4 col-md-10">
                      {flightDetails.destinationAirportName}(
                      {flightDetails.destinationAirportStateName})
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-4 bg-warning">
            ...
            <div className="row m-2">
              <div className="col-6 fw-light">Fare summary</div>
              <div className="col-3 fw-light">Class</div>
              <div className="col-3 fw-light">Base fare</div>
            </div>
            ...
            <div className="row m-2">
              <div className="col-6 fw-light">
                <strong> Child </strong>{" "}
                <input
                  onChange={childrenNumberChanged}
                  type="number"
                  placeholder="0"
                  className="w-25 mx-2"
                />
              ...
              <div className="col-3 fw-light">{childrenPrice} $</div>
            </div>
            ...
            <div className="row m-2">
              ...
              <div className="col-3 fw-light">{adultPrice} $</div>
            </div>
            <hr></hr>
            ...
            <div className="row mx-2">
              ...
              <strong
                className="d-inline offset-4 col-3"
                style={{ fontSize: "18px" }}
              >
                {totalPrice} $
              </strong>
            ...
            <div className="row fw-light mx-3">{totalNumber} Traveller</div>
          </div>
        </div>
      </div>
    </div>
